...
contract CryptoDevsDAO is Ownable {
    struct Proposal {
        ...
        bool executed;
        // voters -a mapping od cryptoDevsNFT tokenIds to bolean ndicating whether that NFT has already been used to cast a vote or not
    ...
    //Create a mapping of ID to proposal to hold all created proposals and counter to count all the the number of proposals that exist
